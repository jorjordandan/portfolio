...
export default function PuzzleBox(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("/puzzleBox.glb") as GLTFResult;
	const {collectPuzzle, hideButton, setButton, addToInventory, puzzle} = useStore();
	const handleClick = () =>{
      ...
      text: "Collect box",
      click: collectPuzzle,
      afterClick: () => printText(["You pick it up. It feels slightly warm. Actually, it doesn't... but it seems like the kind of thing you should say."]),
  ...
  return (
		<>
   { puzzle.visible &&<group ref={group} {...props} dispose={null} onClick={handleClick}>
      <mesh
        castShadow
        receiveShadow
