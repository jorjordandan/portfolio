export const texts = {
  ...
  airplane: [
    "I've 3d printed an airplane. It's a bit small, but it looks throwable.",
  ],
  keeb: [
    "That's my keeb....",
    "It's a Tofu 65 with Kaihl box black switches...",
    'Sounds lovely in my opinion.',
  ],
  speaker: [
  ...
  desk: {
    upButton: {
      ...
      off: [
        'I press the up button, but nothing happens',
        'Maybe I need to turn it on first?',
      ],
    },
    ...
    downButton: {
      ...
      off: [
        'I press the down button, but nothing happens',
        "Seems like it's off.",
      ],
    },
  },
